...
class ResturantsData{
    ...
    private class func getMeghanaResturant() -> ResturantsData{
        ...
        resturantMenu.append(ResturantMenu(menuName: "Veg Manchurian", menuImage: "d1.png", menuPrice: 180,menuQuantity:0))
        resturantMenu.append(ResturantMenu(menuName: "Chicken Tikka", menuImage: "d2.png", menuPrice: 230,menuQuantity:0))
        resturantMenu.append(ResturantMenu(menuName: "Chicken kadai", menuImage: "d3.png", menuPrice: 120,menuQuantity:0))
        resturantMenu.append(ResturantMenu(menuName: "Chicken Butter", menuImage: "d4.png", menuPrice: 200,menuQuantity:0))
        resturantMenu.append(ResturantMenu(menuName: "Mutton Masala", menuImage: "d5.png", menuPrice: 320,menuQuantity:0))
        resturantMenu.append(ResturantMenu(menuName: "Andhra Gongura chicken", menuImage: "d6.png", menuPrice: 140,menuQuantity:0))
        resturantMenu.append(ResturantMenu(menuName: "Veg Thali", menuImage: "d7.png", menuPrice: 160,menuQuantity:0))
        resturantMenu.append(ResturantMenu(menuName: "Chicken Angara", menuImage: "d8.png", menuPrice: 300,menuQuantity:0))
        resturantMenu.append(ResturantMenu(menuName: "Meghana Kadai", menuImage: "d9.png", menuPrice: 100,menuQuantity:0))
        resturantMenu.append(ResturantMenu(menuName: "Meghana 555", menuImage: "d10.png", menuPrice: 210,menuQuantity:0))
        resturantMenu.append(ResturantMenu(menuName: "Gobi Manchurian", menuImage: "d11.png", menuPrice: 220,menuQuantity:0))
        resturantMenu.append(ResturantMenu(menuName: "Mushroom Fry", menuImage: "d12.png", menuPrice: 110,menuQuantity:0))
        resturantMenu.append(ResturantMenu(menuName: "Mushroom Biryani", menuImage: "d13.png", menuPrice: 220,menuQuantity:0))
        resturantMenu.append(ResturantMenu(menuName: "Butter Manchurian", menuImage: "d14.png", menuPrice: 130,menuQuantity:0))
